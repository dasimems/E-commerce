...
<body onload="docfinish()">
    ...
    <div class="back-alert">
        ...
        <div class="alert-one">
            ...
            <button id="yes" onclick="back('sub_categories.php')"><i class="fas fa-check"></i></button><button id="no"><i class="fas fa-times"></i></button>
            ...
            <div class="category">
                ...
                <div class="category-header" <?php getPageSet(); ?>>
                    ...
                    <div class="category-search">
                        ...
                        <form action="searchsubcat.php" method="post">

                            <input type="text" name="categorySearch" placeholder="Sub-Category Search..." />
                    ...
                    <div class="category-btn">
                        ...
                        <a href="sub_categories.php?title=addnewcat"><span><i class="fas fa-folder-plus"></i>&nbsp;&nbsp;Add New Sub-Category</span></a>

                    </div>

                </div>

                <div class="category-body" id="sub-category-body">
                    ...
                    <div class="category-body-container" <?php getPageSet(); ?>>
                        ...
                        <div class="category-body-table" id="sub-category-body-table">
                            ...
                            <table>
                                ...
                                if (isset($_SESSION['catsearch'])) {
                                    ...
                                    if (!empty($_SESSION['catsearch'])) {
                                        ...
                                        $catsearchsql = "SELECT * FROM sub_category WHERE subcattitle LIKE :searchKey";
                                ...
                                ?>
                                                <tr>
                                                    ...
                                                    <td class="exception" style="background: white; color: black;" colspan="8">No Record Found!</td>
                                                ...
                                                while ($catsearchlist = $catsearchstmt->fetch()) {
                                                    ...
                                                    $catlisttitle = $catsearchlist['subcattitle'];
                                                    $catlistcategory = $catsearchlist['category'];
                                                    $catlistaddedby = $catsearchlist['subcaadded_by'];
                                                    $catlistdate = $catsearchlist['subcadate_added'];
                                                    $catlisttime = $catsearchlist['subcatime_added'];
                                                    $srno++;
                                                ...
                                                ?>
                                                    <tr>
                                                        ...
                                                        <td><?php echo ucwords($catlistcategory); ?></td>
                                                        ...
                                                        <td>
                                                            ...
                                                            <a href="deletesubcat.php?id=<?php echo $catlistid; ?>&title=<?php echo $catlisttitle; ?>"><span class="deletcatlist"><i class="fas  fa-trash-alt"></i>&nbsp;&nbsp;DELETE</span></a><br>
                                                            <a href="sub_categories.php?id=<?php echo $catlistid; ?>&name=<?php echo $catlisttitle; ?>&category=<?php echo $catlistcategory; ?>&title=addnewcat"><span class="updatecatlist"><i class="fas  fa-edit"></i>&nbsp;&nbsp;Update</span></a>
                                                        ...
                                                        <span id="available-products" style="background: green; padding:5px 10px; border-radius: 5px;">
                                                            <?php
                                                                ...
                                                                $fetchproductsql = "SELECT * FROM product WHERE psubcategory='$catlisttitle' AND pstatus='available'";
                                                    ...
                                                    <a href="products.php?query=unavailable">
                                                        <span id="available-products" style="background: red; padding:5px 10px; border-radius: 5px; margin-left: 10px;">
                                                            <?php
                                                                ...
                                                                $fetchproductsql = "SELECT * FROM product WHERE psubcategory='$catlisttitle' AND pstatus='unavailable'";
                                                                $fetchproductstmt = $connect->query($fetchproductsql);
                                                                $fetchproductrowcount = $fetchproductstmt->rowCount();
                                    ...
                                    $catlistsql = "SELECT * FROM sub_category ORDER BY subcattitle ASC";
                                    ...
                                    if ($catlistavailable < 1) {
                                        ...
                                        <tr>
                                            ...
                                            <td class="exception" style="background: white; color: black;" colspan="8">You Have No Sub-Category In Your Database</td>
                                        ...
                                        while ($catlist = $catliststmt->fetch()) {
                                            ...
                                            $catlisttitle = $catlist['subcattitle'];
                                            $catlistcategory = $catlist['category'];
                                            $catlistaddedby = $catlist['subcaadded_by'];
                                            $catlistdate = $catlist['subcadate_added'];
                                            $catlisttime = $catlist['subcatime_added'];
                                            $srno++;
                        ...
                        ?>
                                ...
                                <div class="category-back-btn">
                                    ...
                                    <a href="sub_categories.php"><span><i class="fas fa-arrow-left"></i>&nbsp;&nbsp;Back To Sub-Category</span></a>
                    ...
                    <div class="category-form" id="sub-category-form" <?php getPageSetTwo(); ?>>
                        ...
                        <form method="post">
                            ...
                            <div class="form-input">
                                ...
                                <label for="subcattitle">Title</label>
                                <input type="text" name="subcattitle" id="subcattitle" placeholder="Input Sub-Category Title Here..." value="<?php echo isset($_GET['name']) && !empty($_GET['name'])? $_GET['name']: "" ;?>"/>

                            </div>

                            <div class="form-input" id="sub-category-form-input">

                                <label for="cattitle">Choose Category:</label>
                                <select id="cattitle" name="cattitle">

                                    <?php

                                    $categorysql = "SELECT * FROM category ORDER BY catitle ASC";
                                    $categorystmt = $connect->query($categorysql);
                                    $categoryrowcount = $categorystmt->rowcount();
                                    ...
                                    ?>
                                        ...
                                        while ($categorylist = $categorystmt->fetch()) {
                                            $categorytitle = $categorylist['catitle'];


                                        ?>
                                            <option value="<?php echo $categorytitle; ?>"><?php echo ucwords($categorytitle); ?></option>
                            ...
                            <div class="form-input">
                                ...
                                <button type="button" class="back-btn"><i class="fas fa-arrow-left"></i>&nbsp; Back To Sub-Categories</button>

                                <?php 
                                if((!isset($_GET['id']) && !isset($_GET['name']) && !isset($_GET['category'])) || (empty($_GET['id']) && empty($_GET['name']) && empty($_GET['category']))){
                                ?>
                               
                                <button type="submit" class="update-btn" formaction="addnewsubcat.php"><i class="fas fa-check"></i>&nbsp;Add Sub-Category</button>
                                <?php
                                ...
                                <input type="hidden" name="updatesubcatid" value="<?php echo $_GET['id']; ?>">

                                <button type="submit" class="update-btn" formaction="updatesubcat.php"><i class="fas fa-save"></i>&nbsp;Update Sub-Category</button>
