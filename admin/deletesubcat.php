...
if (isset($_GET['id']) && isset($_GET['title'])) {
    ...
    if (!empty($_GET['id']) && !empty($_GET['title'])) {
        ...
        $checkifavailablesql = "SELECT * FROM sub_category WHERE id='$categoryid' AND subcattitle='$categorytitle' LIMIT 1";
        ...
        if ($checkifavailableexec !== 0) {
            ...
            $deletesql = "DELETE FROM sub_category WHERE id='$categoryid' AND subcattitle='$categorytitle'";
            ...
            $_SESSION['errormessage'] = 'Sub-Category Not Found!';
            redirect('sub_categories.php');
        }
    } else {
        redirect('sub_categories.php');
